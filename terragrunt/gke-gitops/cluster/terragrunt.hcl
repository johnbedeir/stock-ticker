...
inputs = {
  ...
  subnetwork                    = dependency.shared.outputs.subnet_self_links["gke-gitops"]
  pods_secondary_range_name     = dependency.shared.outputs.pod_secondary_range_names["gke-gitops"]
  services_secondary_range_name = dependency.shared.outputs.service_secondary_range_names["gke-gitops"]
  ...
  node_service_account_id      = "stock-ticker-gitops-nodes"
